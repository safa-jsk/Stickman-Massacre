...
def hit_enemy_bullet(bullets, enemies):
    ...
    for bullet in bullets:
        ...
        if boss_spawned:
            if dist(bullet['pos'], boss_position) <= 150:
